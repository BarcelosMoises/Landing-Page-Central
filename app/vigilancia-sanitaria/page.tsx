...
const serviceJsonLd = {
  ...
  hasOfferCatalog: {
    ...
    itemListElement: [
      { "@type": "Offer", itemOffered: { "@type": "Service", name: "Projeto Arquitetônico adequado às normas da VISA" } },
      { "@type": "Offer", itemOffered: { "@type": "Service", name: "Projeto de Acessibilidade conforme NBR 9050" } },
      { "@type": "Offer", itemOffered: { "@type": "Service", name: "PGRS — Plano de Gerenciamento de Resíduos Sólidos" } },
      { "@type": "Offer", itemOffered: { "@type": "Service", name: "PGRSS — Plano de Gerenciamento de Resíduos de Serviços de Saúde" } },
      { "@type": "Offer", itemOffered: { "@type": "Service", name: "Acompanhamento até emissão do Alvará Sanitário" } },
    ],
  },
};
      ...
      <main data-service="vigilancia">
        ...
        <section aria-labelledby="hero-titulo" className="relative bg-[#0a0a0a] overflow-hidden">
          <div
            ...
            style={{
              background: "radial-gradient(ellipse 70% 60% at 60% 40%, rgba(13,115,119,0.22) 0%, transparent 70%)",
            }}
            aria-hidden="true"
          />
          ...
          <div className="container-site relative z-10 pt-24 pb-20 md:pt-32 md:pb-28">
            <nav aria-label="Localização na página" className="mb-8">
              <ol className="flex items-center gap-2 text-xs text-neutral-500 font-mono">
                ...
                <li aria-current="page" className="text-neutral-300">Vigilância Sanitária</li>
              </ol>
            </nav>
            ...
            <div className="mb-5">
              ...
              >
                <IconeClipboard />
                <span>Legalização · Vigilância Sanitária</span>
              </span>
            </div>
            ...
            <div className="grid lg:grid-cols-[1fr_auto] gap-12 items-start">
              <div className="max-w-2xl">
                ...
                >
                  Alvará Sanitário —{" "}
                  <span style={{ color: "var(--color-service-accent-light)" }}>regularização completa</span>{" "}

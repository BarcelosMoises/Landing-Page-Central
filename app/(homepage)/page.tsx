...
import { ShieldCheck, FilePenLine, FileCheck2, ArrowRight } from "lucide-react";
...
import { OrgaosReguladoresClaro, OrgaosReguladoresHero } from "@/components/OrgaosReguladores";
    ...
    <>
      ...
      <main id="conteudo-principal" aria-label="Página inicial da Central de Soluções">
        <div className="lg:flex lg:h-[100dvh] lg:flex-col">
          <section id="hero" aria-labelledby="hero-heading" className="relative min-h-[92dvh] overflow-hidden sm:min-h-[58vh] lg:min-h-0 lg:flex-1">
            ...
            <div className="relative z-10 flex h-full min-h-[92dvh] items-start sm:min-h-[58vh] sm:items-center lg:min-h-0">
                ...
                <div className="max-w-3xl">
                  ...
                  <div className="mt-10 flex flex-col items-start gap-4 sm:mt-10 sm:flex-row sm:flex-wrap">
                    <a href={whatsappHero} target="_blank" rel="noopener noreferrer" aria-label="Solicitar orçamento via WhatsApp à Central de Soluções" className="inline-flex w-full items-center justify-center gap-3 rounded-lg bg-[#800000] px-7 py-4 text-base font-semibold text-white transition-all duration-200 hover:bg-[#4f0101] hover:scale-[1.01] active:scale-[0.99] focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-white focus-visible:ring-offset-2 focus-visible:ring-offset-transparent sm:w-auto sm:py-3.5">
                      ...
                      <span>Solicitar Orçamento</span><ArrowRight className="h-5 w-5 shrink-0" aria-hidden="true" />
                    </a>
                  </div>
                  <OrgaosReguladoresHero />
                </div>
              </div>
            </div>
          </section>
          <OrgaosReguladoresClaro />
        </div>
        <MetricasEmpresa />
        <TrustBar />

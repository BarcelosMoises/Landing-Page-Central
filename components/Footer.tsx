...
// Footer compartilhado; superfícies e accents são herdados do layout da rota.
...
export default function Footer() {
  return (
    <footer
      ...
      style={{
        backgroundColor: "var(--color-service-footer, #11110d)",
        borderTopColor: "color-mix(in srgb, var(--color-service-accent, #800000) 45%, transparent)",
      }}
    >
        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-10 md:gap-8">
          <div>
            ...
            <p className="mt-5 text-sm leading-relaxed" style={{ color: "#c4a8a8" }}>
              Engenharia de regularização para indústrias, galpões e telecom. Atendemos RJ, SP, MG e ES (e demais estados sob consulta) com responsabilidade técnica real.
            </p>
          ...
          <div>
            ...
            <nav className="space-y-3 text-sm" style={{ color: "#c4a8a8" }} aria-label="Serviços">
              ...
              <Link href="/laudos-tecnicos" className="block hover:text-white transition-colors">Laudo de Combate a Incêndio</Link>
          ...
          <div>
            ...
            <div className="space-y-3 text-sm" style={{ color: "#c4a8a8" }}>
              <p>Rio de Janeiro (RJ)</p><p>São Paulo (SP)</p><p>Minas Gerais (MG)</p><p>Espírito Santo (ES)</p>
          ...
          <div>
            ...
            <div className="space-y-6 text-sm" style={{ color: "#c4a8a8" }}>
              <div><p className="font-semibold text-white">Durval Ribeiro de Queiroz</p><p>Arquiteto e Urbanista<br />Engenharia de Segurança do Trabalho<br />Engenharia de Segurança Contra Incêndio e Pânico</p></div>
              <div><p className="font-semibold text-white">Theyllor Estulano do Espírito Santo</p><p>Engenheiro Civil<br />Técnico em Mecânica</p></div>
            </div>
          </div>
        </div>
        <div className="mt-12 pt-6 border-t border-white/10 flex flex-col md:flex-row justify-between gap-3 text-xs" style={{ color: "#c4a8a8" }}>

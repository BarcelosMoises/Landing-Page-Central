...
// CTA final das subpáginas — accent da categoria preservado sem mistura com vinho.
...
export function CtaFinal({ titulo, subtitulo, whatsappUrl, email }: CtaFinalProps) {
  return (
    <section
      ...
      style={
        {
          // Base neutra quente: evita transformar verde/azul em marrom-avermelhado.
          // O accent da rota permanece dominante na tonalidade da seção.
          backgroundColor:
            "color-mix(in srgb, var(--color-service-accent, #800000) 24%, #0a0a0a)",
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
        ...
        <div className="flex flex-col sm:flex-row items-center justify-center gap-4">
          ...
          <a
            ...
            className="inline-flex items-center justify-center gap-2 px-8 py-4 rounded-lg font-semibold text-base border border-white/20 hover:bg-white/10 transition-colors duration-200 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-white focus-visible:ring-offset-2 focus-visible:ring-offset-[#0a0a0a]"
            style={{ color: "#e0c8c8" }}
          >
            {email}
          </a>
